...
#pragma omp declare variant (MKL_CBLAS_VARIANT_NAME(cgemm3m_batch)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:A_Array,B_Array,C_Array)
#endif
#pragma omp declare variant (MKL_CBLAS_VARIANT_NAME(cgemm3m_batch)) match(construct={target variant dispatch}, device={arch(gen)})
...
#pragma omp declare variant (MKL_CBLAS_VARIANT_NAME(zgemm3m_batch)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:A_Array,B_Array,C_Array)
#endif
#pragma omp declare variant (MKL_CBLAS_VARIANT_NAME(zgemm3m_batch)) match(construct={target variant dispatch}, device={arch(gen)})
...
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(cgemm3m_batch)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:a_array,b_array,c_array)
#endif
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(cgemm3m_batch)) match(construct={target variant dispatch}, device={arch(gen)})
...
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(zgemm3m_batch)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:a_array,b_array,c_array)
#endif
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(zgemm3m_batch)) match(construct={target variant dispatch}, device={arch(gen)})
...
#pragma omp declare variant (MKL_CBLAS_VARIANT_NAME(cgemm_batch_strided)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:A,B,C)
#endif
#pragma omp declare variant (MKL_CBLAS_VARIANT_NAME(cgemm3m_batch_strided)) match(construct={target variant dispatch}, device={arch(gen)})
...
#pragma omp declare variant (MKL_CBLAS_VARIANT_NAME(zgemm3m_batch_strided)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:A,B,C)
#endif
#pragma omp declare variant (MKL_CBLAS_VARIANT_NAME(zgemm3m_batch_strided)) match(construct={target variant dispatch}, device={arch(gen)})
...
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(cgemm3m_batch_strided)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:a,b,c)
#endif
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(cgemm3m_batch_strided)) match(construct={target variant dispatch}, device={arch(gen)})
...
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(zgemm3m_batch_strided)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:a,b,c)
#endif
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(zgemm3m_batch_strided)) match(construct={target variant dispatch}, device={arch(gen)})
...
#pragma omp declare variant (MKL_CBLAS_VARIANT_NAME(gemm_f16f16f32)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:A,B,C)
#endif
#pragma omp declare variant (MKL_CBLAS_VARIANT_NAME(gemm_f16f16f32)) match(construct={target variant dispatch}, device={arch(gen)})
...
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(cgemm3m)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:a,b,c)
#endif
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(cgemm3m)) match(construct={target variant dispatch}, device={arch(gen)})
...
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(zgemm3m)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:a,b,c)
#endif
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(zgemm3m)) match(construct={target variant dispatch}, device={arch(gen)})
...
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(gemm_f16f16f32)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:a,b,c)
#endif
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(gemm_f16f16f32)) match(construct={target variant dispatch}, device={arch(gen)})
...
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(gemm_bf16bf16f32)) match(construct={dispatch}, device={arch(gen)}) \
    ...
    adjust_args(need_device_ptr:a,b,c)
#endif
#pragma omp declare variant (MKL_BLAS_VARIANT_NAME(gemm_bf16bf16f32)) match(construct={target variant dispatch}, device={arch(gen)})
